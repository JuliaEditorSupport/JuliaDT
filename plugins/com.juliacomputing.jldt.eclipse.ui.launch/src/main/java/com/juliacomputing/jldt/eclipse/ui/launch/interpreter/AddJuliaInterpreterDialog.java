...
public class AddJuliaInterpreterDialog extends AddScriptInterpreterDialog {
    ...
    public AddJuliaInterpreterDialog(IAddInterpreterDialogRequestor requestor, Shell shell, IInterpreterInstallType[] interpreterInstallTypes, IEnvironment environment, IInterpreterInstall editedInterpreter) {
