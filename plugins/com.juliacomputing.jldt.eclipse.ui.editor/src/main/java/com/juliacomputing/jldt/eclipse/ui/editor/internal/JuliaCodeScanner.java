...
public class JuliaCodeScanner extends AbstractScriptScanner {
  ...
  private static final String[] TOKEN_PROPERTIES = { JuliaColourConstants.COMMENT,
      JuliaColourConstants.STRING, JuliaColourConstants.DEFAULT, JuliaColourConstants.KEYWORD };
