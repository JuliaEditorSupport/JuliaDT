...
public class JuliaEditorPreferencesInitializer extends AbstractPreferenceInitializer {
  ...
  public void initializeDefaultPreferences() {
    ...
    PreferenceConverter.setDefault(store, JuliaColourConstants.COMMENT,
        JuliaEditorPreferencesInitializer.COMMENT_COLOUR);
    PreferenceConverter.setDefault(store, JuliaColourConstants.KEYWORD,
        com.juliacomputing.jldt.eclipse.ui.editor.internal.JuliaEditorPreferencesInitializer.KEYWORD_COLOUR);
    PreferenceConverter.setDefault(store, JuliaColourConstants.STRING,
        com.juliacomputing.jldt.eclipse.ui.editor.internal.JuliaEditorPreferencesInitializer.STRING_COLOUR);
