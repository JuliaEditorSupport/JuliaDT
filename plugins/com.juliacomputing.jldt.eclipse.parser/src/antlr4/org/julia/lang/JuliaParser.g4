...
functionDeclaration         :   ID typeParameters? parameters  EQ exp                                   #compactFunctionDeclaration
                            |   FUNCTION ID typeParameters? parameters statement+  END                  #generalFunctionDeclaration
                            ;
