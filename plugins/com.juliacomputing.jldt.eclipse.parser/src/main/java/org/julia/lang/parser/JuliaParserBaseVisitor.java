...
/**
 * This class provides an empty implementation of {@link JuliaParserVisitor}, which can be extended
 ...
 *          type.
 */
public class JuliaParserBaseVisitor<T> extends AbstractParseTreeVisitor<T>
    implements JuliaParserVisitor<T> {
  /**
   * {@inheritDoc}
   *
   * <p>
   ...
   */
  @Override
  public T visitMutableTypeDeclaration(JuliaParser.MutableTypeDeclarationContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitNname(JuliaParser.NnameContext ctx) {
    return visitChildren(ctx);
  }
}