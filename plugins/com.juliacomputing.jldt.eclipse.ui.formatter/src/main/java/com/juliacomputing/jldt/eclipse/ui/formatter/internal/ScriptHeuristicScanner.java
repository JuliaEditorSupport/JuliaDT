...
public abstract class ScriptHeuristicScanner implements ISymbols {
     ...
     * <code>true</code>.
     *
     * @param start     the first character position in <code>fDocument</code> to be
     *                  considered
     * @param bound     the first position in <code>fDocument</code> to not consider
     ...
     * partition.
     *
     * @param position the first character position in <code>fDocument</code> to be
     *                 considered
     * @param bound    the first position in <code>fDocument</code> to not consider
