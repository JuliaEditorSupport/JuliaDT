...
public class JuliaHeuristicScanner extends ScriptHeuristicScanner implements JuliaSymbols {
  private static final int[] BLOCK_BEGINNING_KEYWORDS = { TokenIF, TokenFOR, TokenFUNCTION,
      TokenCASE, TokenCATCH, TokenTYPE, TokenWHILE, TokenLet, TokenBEGIN, TokenMODULE, TokenDO,
      TokenTRY, TokenIMMUTABLE, TokenQuote, TokenMacro };
  ...
  public JuliaHeuristicScanner(IDocument document) {
    super(document, JuliaPartition.JULIA_PARTITIONING, IDocument.DEFAULT_CONTENT_TYPE);
  }
